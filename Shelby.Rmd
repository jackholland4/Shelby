...
# Reusable color scale for majority-minority charts
scale_maj_min_colors <- function() {
  scale_color_manual(
    values = c(
...
# Helper function to read and plot NC shapefiles
plot_nc_shapefile <- function(path, title) {
...
```{r}
plot_nc_shapefile(
  '~/Downloads/School/Thesis/Section 5 Preclearance/Shelby/NC State Senate 1992/1992_Senate_Base_Plan_6.shp',
  "North Carolina State Senate Districts, 1992"
)

plot_nc_shapefile(
  '/Users/jackholland/Downloads/School/Thesis/Section 5 Preclearance/Shelby/NC State Leg 1992/1992_House_Base_Plan_5.shp',
  "North Carolina State House Districts, 1992"
)

plot_nc_shapefile(
  '/Users/jackholland/Downloads/School/Thesis/Section 5 Preclearance/Shelby/NC Congress 1992/92_cong.shp',
  "North Carolina Congressional Districts, 1992"
)
```
\newpage
```{r}
infring_table <- read.csv('/Users/jackholland/Downloads/School/Thesis/Section 5 Preclearance/Shelby/infring_table.csv')

colnames(infring_table) <- c("State",
                             "Poll Tax",
                             "Grandfather Clause",
                             "Old Soldier Clause",
                             "Literacy Test")

# Table with TITLE as the caption
knitr::kable(
  infring_table,
  caption = "Voting Deterrence Mechanisms in Former Confederate States, 1890–1918"
)

# Caption / source printed underneath the table
cat("\n\nSource: Jerrold G. Rusk, *A Statistical History of the American Electorate* ",
    "(Washington DC: CQ Press, 2001), pp. 33–35.\n")
```
