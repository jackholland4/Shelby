...
```
```{r}
nc_1992_house_shp <- st_read('/Users/jackholland/Downloads/School/Thesis/Section 5 Preclearance/Shelby/NC State Leg 1992/1992_House_Base_Plan_5.shp')

ggplot(nc_1992_house_shp) +
  geom_sf() +
  theme_void() +
  labs(
    title = "North Carolina State House Districts, 1992"
  )
```
```{r}
nc_1992_cong_shp <- st_read('/Users/jackholland/Downloads/School/Thesis/Section 5 Preclearance/Shelby/NC Congress 1992/92_cong.shp')

ggplot(nc_1992_cong_shp) +
  geom_sf() +
  theme_void() +
  labs(
    title = "North Carolina Congressional Districts, 1992"
  )
```
```
